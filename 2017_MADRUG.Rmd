...
### ¿qué es Docker? <img src="images/whalepenguingo.png" alt="Docker friends" style="width: 300px;"/>
...
Para todo.Existen imagenes para levantar un contenedor linux que solo ocupa 5 MB
llamado alpine, Ubuntu (188 mb), CentOS (172 mb).....
